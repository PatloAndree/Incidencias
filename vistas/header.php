...
<head>
    ...
    <link rel="icon" type="image/jpg" href="../public/img/wie.ico">
    ...
    <title>Help-Desk UNW</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light static-top mb-5 shadow">
        <div class="container">
            <a class="navbar-brand" href="inicio.php">
                <img src="../public/img/lg2.ico"  width="30%">
            </a>
            ...
            <?php if($_SESSION['usuario']['rol'] == 1) {  ?>
                <li class="nav-item">
                    ...
                    <span class="fas fa-microchip"></span> Mis Equipos
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="misReportes.php">
                        <span class="fas fa-file-alt"></span> Tickets TI 
                    </a>
                </li>
            <?php } else if($_SESSION['usuario']['rol'] == 2) { ?>
                ...
                <li class="nav-item">
                    ...
                    <span class="fas fa-address-book"></span> Equipos TI 
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="reportes.php">
                        <span class="fas fa-file-alt"></span> Tickets
                    </a>
                </li>
            <?php } ?>
